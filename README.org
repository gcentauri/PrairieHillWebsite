...
* Prairie Hill Learning Center
  ...
  - [ ] build an API
	...
	#+begin_src ruby :tangle "./app/controllers/api/logs_controller.rb"
          module Api
	...
	#+begin_src ruby :tangle "./app/controllers/api/periods_controller.rb"
          module Api
	...
	#+begin_src ruby :tangle "./app/views/api/logs/index.json.jbuilder"
          json.logs @logs do |log|
            json.id log.id
            json.amt log.amt
	...
	#+begin_src ruby :tangle "./app/views/api/logs/show.json.jbuilder"
          json.log do
            json.id  @log.id
            json.amt @log.amt
	...
	#+begin_src ruby :tangle "./app/views/api/periods/index.json.jbuilder"
          json.periods @periods do |period|
            json.id period.id
            json.title period.title
          end
	...
	#+begin_src ruby :tangle "./app/views/api/periods/show.json.jbuilder"
          json.period do
            json.id    @period.id
            json.title @period.title
            json.amt   @period.amt

...
ActiveRecord::Schema.define(version: 20150426170244) do

  create_table "activities", force: :cascade do |t|
    t.string   "work_area",   limit: 255
    t.string   "coordinator", limit: 255
    t.boolean  "sign"
    t.integer  "num_tickets"
    t.string   "vol_needed",  limit: 255
    t.text     "shift_ids"
  ...
  create_table "volunteers_shifts", id: false, force: :cascade do |t|
    t.integer "volunteer_id"
    t.integer "product_id"
  end

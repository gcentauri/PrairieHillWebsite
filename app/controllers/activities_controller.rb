class ActivitiesController < InheritedResources::Base
  ...
  def destroy
    @activity.destroy
    redirect_to pages_url, notice: 'Activity was successfully destroyed.'
  end
  ...
  def activity_params
    params.require(:activity).permit(:work_area, :coordinator, :sign, :num_tickets, :vol_needed, :shift_ids)
  end
end
